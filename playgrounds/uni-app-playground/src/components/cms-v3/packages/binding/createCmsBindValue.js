import { iterateComponentData } from '@/components/cms-v3/packages/utils/iterateComponentData';
import { cmsTabsBindingValue } from '@/components/cms-v3/packages/binding/custom/tabs/cms.tabs.bindingValue';
import { cmsProductListBindingValue } from '@/components/cms-v3/packages/binding/custom/product/cms.productList.bindingValue';
import { cmsLiveBindingValue } from '@/components/cms-v3/packages/binding/custom/live/cms.live.bindingValue';
import { cmsCategoryBindingValue } from '@/components/cms-v3/packages/binding/custom/category/cms.category.bindingValue';
import { cmsTabContainerBindingValue } from '@/components/cms-v3/packages/binding/custom/tabContainer/cms.tab.container.bindingValue';
import { cmsSpecialColumnBindingValue } from '@/components/cms-v3/packages/binding/custom/specialColumn/cms.specialColumn.bindingValue';
import { cmsPointProductListBindingValue } from '@/components/cms-v3/packages/binding/custom/pointProduct/cms.pointProductList.bindingValue';
import { cmsPointTabsBindingValue } from '@/components/cms-v3/packages/binding/custom/pointTabs/cms.pointTabs.bindingValue';
