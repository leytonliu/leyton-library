<template>
  ...
  />
  <cms-tab-container
    v-else-if="data.componentCode === 'tab-container' && isVisible"
    :data="data"
    :index="index"
...
import { cmsBaseComponentDefaults } from './utils/constants.js';
import useCmsComponent from './hooks/useCmsComponent.js';
