...
export async function importPublicKey(publicKeyPEM) {
    ...
    return await crypto.subtle.importKey('spki', publicKeyBuffer, {
        name: 'RSA-OAEP',
        hash: 'SHA-256',
    }, false, // 不可导出
    ['encrypt']);
...
export async function importPrivateKey(privateKeyPEM) {
    ...
    return await crypto.subtle.importKey('pkcs8', privateKeyBuffer, {
        name: 'RSA-OAEP',
        hash: 'SHA-256',
    }, false, // 不可导出
    ['decrypt']);
 ...
 */
export async function encryptData(data, publicKeyPEM) {
    // 1. 生成随机 AES 密钥
 ...
 */
export async function decryptData(encryptedData, privateKeyPEM) {
    // 1. 反序列化数据
...
export class E2EEncryption {
    constructor() {
        ...
        Object.defineProperty(this, "exportedKeyPair", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
